...
- **Reps (from watch laps):** 1) 8:27/mi (slow start, 1318m) · 2) 7:49/mi · 3) 7:46/mi · 4) 7:53/mi · 5) 7:37/mi — reps 2–5 all ahead of 7:55 target
...
- **Coach notes:** All 5 reps done with proper 2-minute jog recoveries between each. Rep 1 came in at 8:27/mi over 1318m — still finding pace off the warmup, a slow start. Reps 2–5 all beat the 7:55 target: 7:49, 7:46, 7:53, 7:37 — and the last rep was the fastest. That's the right progression: settling in, then building through the set. Max HR of 184 (97% of 190 max) on rep 5 confirms the system was fully engaged. Cooldown cut short — had to get to work — which explains why total mileage is 6.14 vs 7 prescribed. Not a training miss. RE 100 is right for a full interval session. Note: this week's quality session was rescheduled from Wednesday (lost to a rough day) to Friday — the structure that mattered got done. **Action:** Saturday full rest — non-negotiable after max HR 184. Sunday is 14 mi easy @ 9:20–9:45. If legs are heavy through mile 2, settle at 9:30–9:50 and trust the stimulus is doing its job.
