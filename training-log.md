...
### Sun Aug 9 — ✅ The full 20, in the worst conditions of the cycle — and the fast-finish habit finally broke
<!-- strava_id: 19670998996 -->
- **Prescribed:** Long run: 20 mi easy
- **Actual:** 20.02 mi @ 9:47/mi avg · 3:15:58 moving (3:49:13 elapsed — **33:15 stopped**) · 1,037 ft gain · 8:29 AM start, ~12:19 PM finish
- **Mile splits (pace · HR · elev), miles 1–18:** 1) 9:53 · 140 (−27 ft) · 2) 9:42 · 147 (+46 ft) · 3) 9:28 · 145 (−72 ft) · 4) 9:35 · 151 (+21 ft) · 5) 10:04 · 152 (+53 ft) · 6) 9:50 · 148 (−44 ft) · 7) 9:09 · 159 (+8 ft) · 8) 10:00 · 156 (+28 ft) · 9) 9:56 · 154 (−35 ft) · 10) 9:46 · 159 (+54 ft) · 11) 9:10 · 151 (−28 ft) · 12) 9:52 · 155 (−32 ft) · 13) 9:40 · 157 (−7 ft) · 14) 9:27 · 162 (+3 ft) · 15) 9:14 · 153 (0 ft) · 16) 10:14 · 157 (+34 ft) · 17) 9:54 · 159 (−12 ft) · 18) 9:38 · 160 (−32 ft)
- **Miles 19–21 discarded — GPS contamination.** The split array sums to 20.78 mi against a recorded activity distance of 20.02, all of the 0.76-mi excess landing in the final three splits; split 20 reads 1,752 m in 382 s (5:51/mi) and the file logs a max speed of 9.55 m/s (21.4 mph). That's drift accumulating during the long stationary stops, not running. Miles 1–18 sum to exactly 18.00 mi and are internally clean, so the split table stops there. Totals above are the activity-level figures and are unaffected.
- **HR (avg/max):** 155 / 176 — 81% / 89% of ~190 max · **Relative Effort: 319**
- **Conditions:** ~79°F overnight low with highs forecast into the upper 80s–low 90s, humidity easing only through the afternoon (CBS New York, Aug 8). NWS's Central Park CLI report isn't reachable from this environment, so this is forecast-based rather than an observed reading. The run window is the part that matters: 8:29 AM to ~12:19 PM is roughly three hours past the dawn low and **finishing within an hour or two of the daily peak** — low-to-mid 80s at the start, upper 80s and full overhead sun by the end.
- **Feel (relayed in chat):** "very, very fucking hot." Stopped at 10.1 for water; again around 14 — "thought I was gonna be upside down," drank, took a shoe off; again at 19.3 to walk. "Finished the last .7 eventually. But it was not pretty." Feet hurt badly over the closing miles; JR confirmed it as time-on-feet fatigue, not injury — no blisters, no numbness.
- **Coach notes:** The prescription was 20 and he ran 20.02 — target met, in the hardest conditions any long run has seen this cycle. That alone carries the verdict, and the heat rule applies twice over: nothing here gets marked down for being slow. **The headline is what the splits don't show.** Miles 6–8 of Weeks 6, 7 and 8 all closed with a surge — 9:11 → 8:58 → 7:34 with HR to 179 on Aug 2 was the third straight instance, and the Week 8 recap said the habit needed to break before mileage climbed. It broke. Miles 17 and 18 came in at 9:54 and 9:38 with no push, on the longest run of the cycle, at the point where every previous long run went hunting for a fast finish. That is the single most valuable thing in this file. **Pace discipline was right all day:** 9:47/mi average sits deliberately *below* the 9:20–9:45 easy floor, which is the correct heat adjustment, and the 18 clean splits hold a tight 9:09–10:14 band across 1,037 ft of hills with no collapse — no mile slower than 10:14 even at mile 16. **The cost is in the HR and the effort score, not the pace.** HR drifts 140 → 160 across 18 miles at essentially flat pace — textbook cardiac drift, entirely the heat — and 155 avg (81% of max) sustained for 3:16 is a large aerobic load for a nominally easy run. Relative Effort 319 is the number to sit with: the previous high of this cycle is 113 (Aug 5 intervals), and Aug 7's MP session scored 109. This run cost nearly three times anything else logged. The 33:15 of stopped time across three-plus water stops reads as good judgment in those conditions, not as weakness — the same call as Aug 2's mile-8.4 water stop, and the alternative on a day like this is a much worse outcome. **On the start time:** an 8:29 AM departure is the one real miss, and it's the whole difference between this run and a routine one. The coaching call going in was 5:30, which would have finished the run around 9:00 AM in the low 80s instead of at noon in the upper 80s. Everything hard about today traces back to those three hours. Nothing about it changes the sub-4 picture — 3:49 elapsed is essentially goal-race duration on the feet, which is exactly the durability stimulus a 20 is supposed to deliver.
- **Action:** **Monday's squats + boot camp is cancelled** — RE 319, a four-hour heat exposure and a late concert night do not add up to a squat ladder, and Wednesday's tempo (6 mi @ 8:15/mi) is the session this week is actually built around. Plan tab updated to a full recovery day. Tuesday's 4-mile shakeout happens only if the feet are quiet — cut it or drop it otherwise. Next Sunday is another 20: **5:30 AM start, non-negotiable**, and the same pace restraint shown today. Fueling rehearsal (liquid carbs pre-run, stash bottle on the loop rather than carrying) carries forward to that one.
